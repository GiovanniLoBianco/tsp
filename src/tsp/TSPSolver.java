...
import tsp.heuristic.LexicographicOrder;
 ...
 * #m_solution : the Solution object to modify. This object will store the
 * result of the program. - #m_timeLimit : the maximum time limit (in seconds)
...
public class TSPSolver {
	 ...
	 * 
	 * Do not print text on the standard output (eg. using `System.out.print()`
	 * or `System.out.println()`). This output is dedicated to the result
	 * analyzer that will be used to evaluate your code on multiple instances.
	 * 
	 * You can print using the error output (`System.err.print()` or
	 * `System.err.println()`).
	 * 
	 * When your algorithm terminates, make sure the attribute #m_solution in
	 * this class points to the solution you want to return.
	 * 
	 * You have to make sure that your algorithm does not take more time than
	 * the time limit #m_timeLimit.
	 * 
	 * @throws Exception
	...
	public void solve() throws Exception {
		...
		LexicographicOrder stupidHeuristic = new LexicographicOrder(m_instance, "stupidHeuristic");
		stupidHeuristic.solve();
		m_solution=stupidHeuristic.getSolution();
